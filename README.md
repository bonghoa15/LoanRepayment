...
notebooks
   |-- EDA: notebook to explore datasests
   |-- prediction: notebooks to train ML
data : input dataset
viz : auto EDA visualization
   |-- version1: visualization from features using for model version 1
   |-- version2: visualization from features using for model version 2
   |-- version3: visualization from features using for model version 3
model : output from MLs
   |-- final_lgb_model_optuna*: tuning optuna 
   |-- lgb_*.pkl: pretrained models
